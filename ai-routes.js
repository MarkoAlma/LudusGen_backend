...
const REQUIRED_KEYS = [
  ...
  'OPENROUTER_API_KEY', 'DEEPSEEK_API_KEY', 'MESHY_API_KEY',
];
...
// ════════════════════════════════════════════════════
// 6.  MESHY — Text to 3D Preview
//     POST /api/meshy/text-to-3d
//     Body: { prompt, ai_model?, topology?, target_polycount?,
//             should_remesh?, symmetry_mode?, pose_mode?, moderation? }
// ════════════════════════════════════════════════════
